...
[`PORTFOLIO`](https://etrnkz.vercel.app)
[`TELEGRAM`](https://t.me/etrnkz)
[`LINKEDIN`](https://linkedin.com/in/etrnkz)
[`GITHUB`](https://github.com/etrnkz)
`AVAILABLE`
...
NAME:   Etrnkz
TYPE:   Reverse Engineer / Backend Developer
...
![Stars](https://img.shields.io/badge/STARS-97-dc143c?style=for-the-badge&labelColor=111)
![Followers](https://img.shields.io/badge/FOLLOWERS-117-dc143c?style=for-the-badge&labelColor=111)
![Repos](https://img.shields.io/badge/REPOS-25-dc143c?style=for-the-badge&labelColor=111)

---

**`0x0020`** `tech stack`

`Python` `JavaScript` `TypeScript` `Rust` `Node.js` `Prolog` `Docker` `PostgreSQL`
...
**`0x0040`** `recent activity`

>_ fetching latest activity...
...
[`DM ON TELEGRAM`](https://t.me/etrnkz) [`EMAIL`](mailto:) `VISITORS: --`
