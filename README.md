...
<!-- Decoder SVG — pure SVG with animate elements, no CSS/style tags -->
<svg viewBox="0 0 640 200" width="100%" style="max-width:660px" xmlns="http://www.w3.org/2000/svg">
  ...
  <line x1="0" y1="0" x2="640" y2="0" stroke="rgba(220,20,60,.4)" stroke-width="1.5" opacity="0">
    <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.9;1" dur="4s" repeatCount="indefinite"/>
    <animateTransform attributeName="transform" type="translate" values="0,0;0,160;0,160;0,0" keyTimes="0;0.9;1;1" dur="4s" repeatCount="indefinite"/>
  </line>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.04;0.12;1" dur="5s" fill="freeze"/>
    ...
    <text x="85" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="85" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      E<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.08;0.16;1" dur="5s" fill="freeze"/>
    ...
    <text x="163" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="163" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      T<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.12;0.2;1" dur="5s" fill="freeze"/>
    ...
    <text x="241" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="241" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      R<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.16;0.24;1" dur="5s" fill="freeze"/>
    ...
    <text x="319" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="319" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      N<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.2;0.28;1" dur="5s" fill="freeze"/>
    ...
    <text x="397" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="397" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      K<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>

  <g opacity="0">
    <animate attributeName="opacity" values="0;0;1;1" keyTimes="0;0.24;0.32;1" dur="5s" fill="freeze"/>
    ...
    <text x="475" y="90" text-anchor="middle" font-family="monospace" font-size="9" fill="#dc143c">&#x25BC;
      <animateTransform attributeName="transform" type="translate" values="0,0;0,-2;0,0" dur="2s" repeatCount="indefinite"/>
    </text>
    <text x="475" y="122" text-anchor="middle" font-family="Courier New,monospace" font-size="32" font-weight="900" fill="#dc143c" opacity=".6">
      Z<animate attributeName="opacity" values=".6;1;.6" dur="2s" repeatCount="indefinite"/>
    </text>
  </g>
  ...
  <rect x="100" y="164" height="2" fill="#dc143c">
    <animate attributeName="width" values="0;420" dur="2.5s" begin="0.5s" fill="freeze"/>
  </rect>
  <rect x="100" y="164" width="100" height="2" fill="rgba(255,255,255,.15)" opacity="0">
    <animate attributeName="opacity" values="0;.3;0" dur="1.5s" repeatCount="indefinite"/>
    <animateTransform attributeName="transform" type="translate" values="-100,0;200,0" dur="1.5s" repeatCount="indefinite"/>
  </rect>
</svg>
...
<div>
  <a href="https://etrnkz.vercel.app"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;background:transparent;text-decoration:none;margin:2px">PORTFOLIO</span></a>
  <a href="https://t.me/etrnkz"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;background:transparent;text-decoration:none;margin:2px">TELEGRAM</span></a>
  <a href="https://linkedin.com/in/etrnkz"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;background:transparent;text-decoration:none;margin:2px">LINKEDIN</span></a>
  <a href="https://github.com/etrnkz"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;background:transparent;text-decoration:none;margin:2px">GITHUB</span></a>
  <span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #00c853;color:#00c853;margin:2px">STATUS: AVAILABLE_FOR_WORK</span>
</div>
...
<div style="margin:20px 0;font-family:'Courier New',monospace">
  <div style="color:#555;font-size:10px;letter-spacing:1px;margin-bottom:6px;display:flex;align-items:center;gap:8px">
    ...
    <span style="color:#2a2a2a">|</span>
    <span style="color:#888;letter-spacing:2px">stats &amp; activity</span>
  </div>
  <div style="background:#050505;border:1px solid #1a1a1a;padding:16px;text-align:center">
    ...
    <img src="https://img.shields.io/badge/COMMITS_2026-241-dc143c?style=for-the-badge&labelColor=111" alt="Commits"/>
  </div>
</div>
...
<div align="center">
  ...
  <div>
    <a href="https://t.me/etrnkz"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;margin:2px">DM ON TELEGRAM</span></a>
    <a href="mailto:"><span style="display:inline-block;padding:5px 12px;font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;border:1px solid #dc143c;color:#dc143c;margin:2px">EMAIL</span></a>
